    ...
    >
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-6 px-5 md:grid-cols-2 md:gap-16 md:px-8">
        ...
        <div className={focused ? "relative z-0" : "relative"}>
          ...
          <motion.h2
            className="mt-4 font-display text-4xl leading-none tracking-tight uppercase md:text-5xl"
          ...
          >
            Más que un
            <br />
            <span className="font-script text-5xl font-normal normal-case tracking-normal text-gals-blue-soft md:text-6xl">
              studio de pilates
            </span>
          </motion.h2>
          <motion.p
          ...
          >
            Vive en Rosales, el Chicó, la 93 o cerca de la 97. Tiene una vida
            bien construida por fuera — trabaja, viaja, cuida a otros. Busca un
            espacio que sea completamente suyo: una experiencia, no un gimnasio.
          </motion.p>
          <motion.p
          ...
          >
            Ritual responde dónde te movés. Transformación, quién te acompaña.
            Ilimitada, quién te conoce de verdad. Cuando encuentra eso, es leal.
          </motion.p>
          <motion.a
            href={WHATSAPP_URL}
            target="_blank"
